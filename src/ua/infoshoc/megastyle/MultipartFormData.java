...
public class MultipartFormData {
	...
	public MultipartFormData(Context context, String requestURL, String cookies, String charset) throws IOException, KeyStoreException, NoSuchAlgorithmException, CertificateException, KeyManagementException{
		...
		InputStream caInput = context.getResources().openRawResource(R.raw.rapidssl);
		Certificate ca;
	...
	public MultipartFormData add(String name, File file) throws IOException{
		...
		if ( file != null && file.exists() ){			
			...
			printWriter
				.append("Content-Disposition: form-data; name=\"" + name + "\"; filename=\"" + fileName + "\"").append(LINE_FEED)
			...
			for ( int bytesRead = inputStream.read(block); bytesRead != -1; bytesRead = inputStream.read(block) ){
