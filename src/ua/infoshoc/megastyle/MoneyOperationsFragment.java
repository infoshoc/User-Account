...
public class MoneyOperationsFragment extends Fragment implements
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		rootView = inflater.inflate(R.layout.fragment_money_operations,
				container, false);
		...
		paymentTabButton = (Button) rootView
				.findViewById(R.id.payment_tab_button);
		withdrawalTabButton = (Button) rootView
				.findViewById(R.id.withdrawal_tab_button);
